...
function rX(d) {
  c.toggleClass("transition").css(
    "transform",
    "translate3d(" + x + "px, " + y + "px, " + z + "px) rotateX(" + d + "deg)"
  );
}
function rY(d) {
  c.toggleClass("transition").css(
    "transform",
    "translate3d(" + x + "px, " + y + "px, " + z + "px) rotateY(" + d + "deg)"
  );
}
function rZ(d) {
  c.toggleClass("transition").css(
    "transform",
    "translate3d(" + x + "px, " + y + "px, " + z + "px) rotateZ(" + d + "deg)"
  );
}
